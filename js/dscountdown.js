...
(function($){
	...
	$.fn.dsCountDown = function(givenOptions){
		...
		var defaults = {
			...
			theme: 'balance',				// Set the theme 'white', 'black', 'red', 'flat', 'custome'
			
			titleDays: 'd',			// Set the title of days
			titleHours: 'h',		// Set the title of hours
			titleMinutes: 'm',	// Set the title of minutes
			titleSeconds: 's',	// Set the title of seconds
